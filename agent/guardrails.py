...
_MSG_TOO_LONG = "Aap ka message bohat lamba hai. Baraye meharbani thora mukhtasar likhein."
...
_MSG_ABUSE = (
    "Baraye meharbani mohzbana andaaz mein baat karein taake main aap ki behtar madad kar sakoon."
)
...
_ABUSE_PATTERNS = [
    ...
    r"\bharaam\s*zada\b", r"\bkutt?a\b", r"\bgandu\b", r"\bmadarchod\b", r"\bbehnchod\b",
]
...
def check_input(text: str) -> GuardrailResult:
    ...
    if _INJECTION_RE.search(stripped):
        ...
        return GuardrailResult(False, reason="prompt_injection", user_message=_MSG_INJECTION)

...
class VectorSearchInput(BaseModel):
    ...
    user_id: Optional[str] = Field(default=None, description="User ID for filtering private documents")
...
async def hybrid_search_tool(input_data: HybridSearchInput) -> List[ChunkResult]:
    ...
    try:
        ...
        try:
            ...
            logger.warning("HybridRetriever unavailable, falling back: %s", retriever_exc)
